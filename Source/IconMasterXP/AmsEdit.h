...
//
// AmsEdit is a CEdit implementation by Alvaro Mendez with various validation options. It is used for numeric edit fields.
...
#define AMSEDIT_COMPILED_CLASSES	AMSEDIT_NUMERIC_CLASS
